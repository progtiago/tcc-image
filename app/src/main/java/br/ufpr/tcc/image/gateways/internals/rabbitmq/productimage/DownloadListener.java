...
public class DownloadListener {
  ...
  @RabbitListener(
      queues = "${spring.rabbitmq.queues.product-images.download.name}",
      containerFactory = "downloadQueueContainerFactory")
  public void execute(final Message message) {
    try {
      ...
      log.error("Rabbit Listener {} has failed for message {}.",
          queueProperties.getDownloadQueueProperties().getName(),
          message,
          ex);
    }
  }
